                ...
                <div class="card" style="margin-top: 20px; margin-bottom: 20px">
                    <div class="card-body">
                        ...
                        <div v-for="item in articles" :key="item.id">
                          <router-link :to="'/article/'+item.id" target="_blank" style="color: black;text-decoration: none;">
