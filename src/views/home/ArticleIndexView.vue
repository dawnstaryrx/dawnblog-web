        ...
        <div class="row">
            ...
            <div class="col-9">
                <div class="card" style="margin-top: 20px; margin-bottom: 20px">
                    <div class="card-body">
                            <div class="h3" style="font-weight: bolder;">{{ article.title }}</div>
                            ...
                            <span class="thumbs-up" v-clipboard:success="success" @click="copy(article.title + '链接： http://localhost/article/' + article.id)">
