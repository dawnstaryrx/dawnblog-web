<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
      <router-link class="navbar-brand" style="font-family:New Century Schoolbook, TeX Gyre Schola, serif"
        :to="{ name: 'index' }">DawnStar</router-link>
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <router-link :class="route_name == 'blog_index' ? 'nav-link active' : 'nav-link'" aria-current="page"
              :to="{ name: 'index' }">首页</router-link>
          </li>
          <li class="nav-item">
            <router-link :class="route_name == 'write_index' ? 'nav-link active' : 'nav-link'"
              :to="{ name: 'write_index' }">创作</router-link>
          </li>
          <li class="nav-item">
            <router-link :class="route_name == 'random_index' ? 'nav-link active' : 'nav-link'"
              :to="{ name: 'random_index' }">随机</router-link>
          </li>
          <li class="nav-item">
            <router-link :class="route_name == 'music_index' ? 'nav-link active' : 'nav-link'"
              :to="{ name: 'music_index' }">音乐</router-link>
          </li>
        ...
        <button v-if="rightShow()" class="btn btn-chat" type="button" data-bs-toggle="offcanvas"
          data-bs-target="#offcanvasWithBothOptions" aria-controls="offcanvasWithBothOptions">
          <svg t="1708829219462" class="icon" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
            p-id="2958" width="25" height="25">
            <path
        ...
        <ul v-if="rightShow()" class="navbar-nav">
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" style="padding: 0;" href="#" id="navbarDropdown" role="button"
              data-bs-toggle="dropdown" aria-expanded="false">
              <img :src="this.avatar" width="41px" alt="" style="padding: 0;">
              <!-- {{ username }} -->
            </a>
        ...
        <ul v-else class="navbar-nav">
          <li class="nav-item">
            <router-link :class="route_name == 'user_login' ? 'nav-link active' : 'nav-link'"
              :to="{ name: 'user_login' }">登录</router-link>
          </li>
          <li class="注册">
            <router-link :class="route_name == 'user_register' ? 'nav-link active' : 'nav-link'"
  ...
  <!-- Modal -->
  <div class="modal fade" id="a233" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel"
    aria-hidden="true">
